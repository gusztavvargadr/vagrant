...
property :user, String, default: node['gusztavvargadr_vagrant_windows']['powershell_script_elevated']['username']
property :password, String, default: node['gusztavvargadr_vagrant_windows']['powershell_script_elevated']['password']
property :cwd, String, default: 'C:\\'
property :code, String, required: true
property :wait_poll, Integer, default: 5

action :run do
  script_directory_path = "#{Chef::Config[:file_cache_path]}/gusztavvargadr_vagrant_windows"
